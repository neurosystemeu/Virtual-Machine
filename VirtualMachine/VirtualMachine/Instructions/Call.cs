...
{
    public class Call : InstrukcjaBazowa
    {
        ...
        public void WykonajMetode(MethodReference mr, object instancja)
        {
            ...
            if (md != null && md.IsGetter == true)
            {
                ...
                var adres = instancja as AdresZmiennej;
                if (adres != null)
                {
                    instancja = adres.PobierzZmienna();
                }
        ...
        public bool CzyWykonacCzyInterpretowac(MethodReference mr)
        {
            ...
            var czyKlasaMaAtrybut = md.DeclaringType.CustomAttributes.Any(a => a.AttributeType.FullName == typeof(InterpertujAttribute).FullName);
            var czyMetodaMaAtrybut = md.CustomAttributes.Any(a => a.AttributeType.FullName == typeof(InterpertujAttribute).FullName);
