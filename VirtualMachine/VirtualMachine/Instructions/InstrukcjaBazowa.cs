...
{
    public class InstrukcjaBazowa
    {
        public InstrukcjaBazowa(Instruction ins)
        {
            instrukcja = ins;
            if (ins != null)
            {
        ...
        public AdresZmiennejLokalnej PobierzAdresZmiennejLokalnej(int indeks)
        {
            var adres = new AdresZmiennejLokalnej();
            adres.Indeks = indeks;
        ...
        public AdresArgumentu PobierzAdresArgumentu(int indeks)
        {
            var adres = new AdresArgumentu();
            adres.Indeks = indeks;
        ...
        public object Pop()
        {
            ...
            if(ob is AdresZmiennej)
            {
                var adres = ob as AdresZmiennej;
                return adres.PobierzZmienna();
            }
        ...
        public static InstrukcjaBazowa UtworzInstrukcje(Instruction instrukcja)
        {
            try
            {
